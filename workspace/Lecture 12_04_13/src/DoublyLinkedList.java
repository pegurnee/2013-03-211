public class DoublyLinkedList {
    ...
    public class DoublyLinkedIterator {
        ...
        public boolean hasPrevious() {
            // return (this.position.previous != DoublyLinkedList.this.head);
            // return (position.previous != null);
            return (position != null);
        }

        /**
         * Starts the list at the end. Extra Credit
         * 
         * @author Eddie Gurnee
         * @version 12/04/2013
         */
        ...
        /*
         * EC +5pts each 1) Write an iterator method startAtEnd() that will set
         * the position to the last node in a doubly linked list. 2) Write an
         * iterator method previous() that will set the position to the previous
    ...
    /*
     * < Other methods would normally be defined here, such as an equals, clone,
     * find, or contains methods. They have been left off to simplify the
     * example. >
     */
}
